...
class DataBrowser(WPHandler):
    ...
    def show_table(self, req, relpath, table=None, show_shadowed="", tag="", data_type=None, numeric_time="no", namespace="public", **args):
        ...
        t = db.openFolder(namespace_table)
    ...
    def plot_table(self, req, relpath, namespace="public", table=None, **args):
        ...
        if table_selected:
            ...
            # t = db.openFolder(namespace+"."+table)    #VP
        ...
        if do_plot and table_selected:
            ...
            if type_selected:
                data_url += "&data_type=%s" % (type_selected,)
            print(data_url)
    ...
    def table_data(self, req, relpath, table = None, column = None, t0 = None, t1 = None,
        ...
        resp = self.render_to_response("table_data.json", channels=chan_list, data=data_out, table=table, t0=t0, t1=t1)
